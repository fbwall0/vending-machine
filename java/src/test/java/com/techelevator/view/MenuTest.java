...
public class MenuTest {
	...
	@Test
	public void redisplays_menu_if_user_enters_garbage_with_money() {
		Object[] options = new Object[] { "Larry", "Curly", "Moe" };
		Menu menu = getMenuForTestingWithUserInput("Mickey Mouse\n1\n");

		menu.getChoiceFromOptions(options, new BigDecimal("10.00"));
	...
	@Test
	public void displays_a_list_of_menu_options_and_prompts_user_to_make_a_choice_with_hidden_option() {
		Object[] options = new Object[] { Integer.valueOf(3), "Blind", "Mice" };
		Menu menu = getMenuForTesting();

		menu.getChoiceFromOptions(options, 1);
